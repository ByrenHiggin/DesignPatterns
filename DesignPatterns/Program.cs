...
namespace DesignPatterns
{
    ...
    public class Menu
    {
        ...
        void PerformSolid()
        {
            var SingleResponsibility = _lifetimeScope.Resolve<DesignPatterns.SingleResponsibility.SOLID_SingleResponsibility_Principle>();
            var OpenClosed = _lifetimeScope.Resolve<DesignPatterns.OpenClosed.SOLID_OpenClosed_Principle>();
        }
    }
